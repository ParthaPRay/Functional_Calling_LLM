...
routes = [
    Route(
        ...
        dynamic=True,
        functions=[factorial, get_coordinates, heap_sort, list_files, get_current_time_in_city, get_exchange_rate],
        function_schemas=[factorial_schema, get_coordinates_schema, heap_sort_schema, list_files_schema, get_current_time_in_city_schema, get_exchange_rate_schema]
    )
]
